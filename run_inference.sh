...
if [ $# -lt 3 ]; then 
    ...
    conda run --no-capture-output -n xview3 python3 reference/inference.py --image_folder "$1" --scene_ids "$2" --output "$3" --weights /home/xview3/baseline/trained_model_5_epochs.pth --chips_path /home/ubuntu/data-pipe-chips 2>&1 | tee -a /mnt/log.txt
